...
<form name="form1" method="post" action="">
  <table width="900" border="0" cellpadding="3" align="center" id="table">
    ...
    include ('configuration/conexion.php');
	 ...
	 $consulta="SELECT * 
	 			FROM t_entrenador 
	 			WHERE coordinado_por='$_SESSION[id_coordinador]'
				ORDER BY id_entrenador DESC LIMIT 100
				";
	...
	?>
	  ...
	  ?></td>
			...
			?></td>
          <td height="21">
             <a href="clases/clase_consulta.php?id_entrenador=<?php echo $id_entrenador?>"><img src="imagenes/deportes.jpg" width="30" height="25"></a>
	  </td>
      <td height="21">
             <a href="horario/horario_entrenador.php?id_entrenador=<?php echo $id_entrenador?>"><img src="imagenes/horario.png" width="40" height="40"></a>
	  </td>
        </tr>
        <?php
	 $i++;
