  ...
  function Header() //Encabezado
    {
		...
		$this->Ln(35);
      	$this->Cell(180,5,utf8_decode('Emergencia'),0,0,'C');
		$this->Ln(26);
	...
	function cabeceracupos($cabecera)
    {
		...
		$this->SetFillColor(41,97,69);//Fondo verde de celda
        $i=0;
...
$datos_emergencia= array($registro['nombre_emerg']." ".$registro['apellido_emerg'], $registro['parentesco_emerg'], $registro['ocupacion_emerg'],$registro['tlf_emerg'], ($registro['trabajo_emerg']));
